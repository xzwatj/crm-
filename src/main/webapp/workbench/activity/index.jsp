				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <input class="form-control" id="search-startDate  startTime" type="text"  />
				    </div>
				  </div>
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">结束日期</div>
					  <input class="form-control" type="text" id="earch-endDate endTime">
				    </div>
				  </div>
				  
				  <button type="button" id="searchBtn" class="btn btn-default" id="searchBtn">查询</button>
